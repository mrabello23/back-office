...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script src="{{ asset('bootstrap-datepicker-1.9.0/locales/bootstrap-datepicker.pt-BR.min.js') }}"></script>
        ...
        <link rel="stylesheet" href="{{ asset('bootstrap-datepicker-1.9.0/css/bootstrap-datepicker.min.css') }}">
